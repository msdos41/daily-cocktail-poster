...
export const ui = {
  en: {
    ...
    shareCardLabel: "Create share card",
    shareCardTitle: "Choose a format",
    shareCardHelp: "Generate a platform-ready PNG card.",
    close: "Close",
  ...
  "zh-CN": {
    ...
    createShareCard: "生成分享卡片",
    shareCardLabel: "生成分享卡片",
    shareCardTitle: "选择分享格式",
    shareCardHelp: "生成适合平台发布的 PNG 卡片。",
    close: "关闭",
    closeMenu: "关闭菜单",
    closeRecipe: "关闭配方",
    recipeDetails: "完整配方",
